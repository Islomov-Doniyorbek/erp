...
export default function Page() {
  ...
  const sumFact = merging
    .filter(f => String(f.dealId) === String(contractId))
    .filter(f => f.cftype === "invoice")
    .reduce((acc, f) => acc + Number(f.totalSum), 0);
              ...
              .map(doc => (
                <tr 
                  ...
                  className={`
                    ...
                    ${q !== null ? Number(q) === doc.id ? "text-red-600" : "" : ""}
                  `}
                >
                  ...
                  <td className='border'>
                    <div className='flex'>
                      ...
                      <div className='w-[40%] pl-1.5 py-2'>
                        {formatNumber(Number(doc.totalSum))}
                      </div>
                    </div>
                  </td>
                </tr>
